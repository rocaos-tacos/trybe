...
const PhoneMockup: React.FC<PhoneMockupProps> = ({ children, className = '' }) => {
  return (
    <div className={`relative mx-auto border-stone-800 bg-stone-800 border-[8px] rounded-[2.5rem] h-[580px] w-[300px] shadow-2xl flex flex-col overflow-hidden ${className}`}>
